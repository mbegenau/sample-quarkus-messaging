...
public @interface ActivationConfigProperty {
    ...
    String ACKNOWLEDGE_MODE = "acknowledgeMode";
    String MESSAGE_SELECTOR = "messageSelector";
    String DESTINATION_TYPE = "destinationType";
    String DESTINATION_LOOKUP = "destinationLookup";
    String CONNECTION_FACTORY_LOOKUP = "connectionFactoryLookup";
    String SUBSCRIPTION_DURABILITY = "subscriptionDurability";
